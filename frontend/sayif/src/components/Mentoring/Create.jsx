...
function Create() {
    ...
    const CreateView = (
        <> 
                                ...
                                <div style={{display: "flex", gap: "10px"}}>
                                    {['월', '화', '수', '목', '금', '토', '일'].map(day => (
                                        <S.CustomDayBtn
                                            ...
                                            variant='outlined'
                                            style={{
                                                backgroundColor: selectDays.includes(day) ? '#C6D0BE' : 'white'
                                            }}
            ...
            <S.BtnGroup>
                <S.CustomCancelBtn variant="contained" onClick={handleCancleBtn}>취소</S.CustomCancelBtn>
                <S.CustomRegistBtn variant="contained" onClick={handleCompleteBtn}>완료</S.CustomRegistBtn>
            </S.BtnGroup>
                </>
            }
           {showFinish && 
