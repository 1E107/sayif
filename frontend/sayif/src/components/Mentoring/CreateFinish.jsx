...
function CreateFinish() {
    ...
    const FinishView = (
        <S.Container>
            <DownloadDoneIcon style={{fontSize:"185PX", color:"#116530"}}></DownloadDoneIcon>
            ...
            <S.CustomBtn variant="contained" onClick={handleClick} style={{fontSize: "18px"}}>확인</S.CustomBtn>
        </S.Container>
    );
