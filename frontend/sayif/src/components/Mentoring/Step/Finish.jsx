    ...
    const SelectMentorView = (
        <S.Container>
            ...
            <S.ShowTextWrapper>
                ...
                <S.SubText>
                    멘토링은 시작일로부터 <span style={{color:"#BA9C03"}}>3일 전</span>에 신청 마감되며, 최소 인원 충족 시 진행됩니다.<br/>
                    <span style={{color:"#BA9C03"}}>하나</span>의 멘토링만 신청 및 진행 가능합니다. <br/>
                    <S.SubTextHigh>마이페이지 - 멘토링 신청 조회</S.SubTextHigh>에서 신청 <span style={{color:"#BA9C03"}}>변경 / 취소</span> 가능합니다. <br/>
                </S.SubText>
                <Button 
                        variant="contained"
