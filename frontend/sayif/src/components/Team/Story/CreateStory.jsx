...
function CreateStory() {
    ...
    const CreateStoryView = (
        <S.Container>
            ...
            <S.Form>
                <S.ContentText>사연함에 여러분의 소중한 이야기를 남겨주세요! <br/> 익명으로 작성하실 수 있으니, 편안한 마음으로 자유롭게 남겨주시면 됩니다 :)</S.ContentText>  
                <div><S.CustomTextarea onChange={handleContent}/></div>
                <S.CustomBtn variant="contained" onClick={submitStory}>사연 남기기</S.CustomBtn>
            </S.Form>
        </S.Container>
    )
